...
{
    echo  ' ================================================================ '
    echo  ' --ssl-domain: 生成ssl证书需要的主域名，如不指定则默认为test.io.local，如果是ip访问服务，则可忽略；'
    ...
    echo  ' 通过 openssl 本地校验:'
    echo  ' openssl verify -CAfile cacerts.pem tls.crt'
    echo  ' openssl x509 -in tls.crt -noout -text'
    echo  ' ================================================================'
}
...
SSL_DOMAIN=${SSL_DOMAIN:-'test.io.local'}
